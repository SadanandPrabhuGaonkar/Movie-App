...
//main call runs on first iteration
getMovies(API_URL);
...
function showMovies(data) {
    ...
    data.forEach(movie => {
        const { id, original_title, title, poster_path, vote_average, overview } = movie;//store into constants
        ...
        `
        main.appendChild(movieEl);//apppends to main
    })
}
